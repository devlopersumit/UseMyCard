      ...
      <div className="max-w-[1200px] mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center no-underline text-[#2563eb] text-2xl md:text-3xl font-bold">
          <img
            src={logo}
            alt="UseMyCard"
            className="h-[40px] w-auto mr-2 transition-transform duration-300 ease-in-out hover:scale-105 md:h-[45px]"
          />
        ...
        >
         ...
         <div className="hidden md:flex items-center gap-6">
                    {!user ? (
                        <>
                            <a href="#features-card" className="text-gray-600 hover:text-[#907CE2] transition-colors">Features</a>
                            <a href="#how-it-works" className="text-gray-600 hover:text-[#907CE2] transition-colors">How it Works</a>
                            <a href="#faq" className="text-gray-600 hover:text-[#907CE2] transition-colors">FAQ</a>
                        ...
                        <>
                            ...
                            <button onClick={handleLogout} className="ml-4 px-5 py-2 rounded-full bg-red-500 text-white font-semibold hover:bg-red-600 transition-all">Logout</button>
                        </>
                    )}
                </div>
        ...
        >
          <div className="flex flex-col p-4 space-y-4">
            <a
              href="#features"
              className="text-gray-600 hover:text-[#907CE2] transition-colors py-2"
            >
              Features
            </a>
            <a
            ...
            <div className="flex flex-col gap-3 pt-2">
              <button
                ...
                className="w-full py-2 rounded-full font-semibold text-[#907CE2] bg-transparent border-2 border-[#907CE2] hover:bg-[#907CE2] hover:text-white transition-all duration-300"
              >
                Login
              </button>
              <button
                onClick={() => setModalType("signup")}
                className="w-full py-2 rounded-full font-semibold text-white bg-[#907CE2] hover:bg-[#7B68EE] transition-all duration-300 shadow-lg"
              >
                Sign Up
              </button>
            </div>
          ...
          <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] relative transition-all animate-fade-in">
            ...
            <form onSubmit={handleAuth}>
              <input
                type="email"
                placeholder="Email"
                className="w-full mb-4 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#907CE2]"
                value={email}
              ...
              <button
                type="submit"
                className="w-full mb-5 bg-[#907CE2] hover:bg-[#7B68EE] text-white py-3 rounded-lg font-semibold transition-all duration-300"
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-300 py-3 rounded-lg font-medium hover:bg-gray-50 transition-all duration-300 bg-[#2563EB] text-white hover:text-black"
            >
              <img
